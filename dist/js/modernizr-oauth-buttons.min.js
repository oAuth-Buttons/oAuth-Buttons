...
!function (e, n, t) {
  function r(e, n) {
    ...
    function a() {
      ...
      if (m = e[c], g = k.style[m], l(m, "-") && (m = f(m)), k.style[m] !== t) {
        if (o || r(s, "undefined")) return a(), "pfx" == n ? m : !0;try {
          k.style[m] = s;
        } catch (h) {}if (k.style[m] != g) return a(), "pfx" == n ? m : !0;
      }
    }return a(), !1;
  }function y(e, n, t, s, o) {
    var i = e.charAt(0).toUpperCase() + e.slice(1),
        l = (e + " " + N.join(i + " ") + i).split(" ");return r(n, "string") || r(n, "undefined") ? g(l, n, s, o) : (l = (e + " " + T.join(i + " ") + i).split(" "), u(l, n, t));
  }function h(e, n, r) {
    return y(e, t, t, n, r);
  }var S = [],
      C = [],
      ...
      E = "supportsCSS" in e;Modernizr.addTest("supports", b || E);var P = w._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];w._prefixes = P;var z = "Moz O ms Webkit",
    ...
    if (Modernizr.supports) return h("filter", "blur(2px)");var e = i("a");return e.style.cssText = P.join("filter:blur(2px); "), !!e.style.length && (n.documentMode === t || n.documentMode > 9);
  }), s(), o(S), delete w.addTest, delete w.addAsyncTest;for (var A = 0; A < Modernizr._q.length; A++) {
    Modernizr._q[A]();
  }e.Modernizr = Modernizr;
}(window, document);
//# sourceMappingURL=modernizr-oauth-buttons.min.js.map
